            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    try{
                        ...
                        excecao="Error ao cadastrar Usuário:"+e.getMessage();
                        e.printStackTrace();
                    }
        ...
        if(!textoNome.isEmpty()){
            if(!textoEmail.isEmpty()){
                if(!textoSenha.isEmpty()){
                    ...
                    Toast.makeText(CadastroActivity.this,"Peencha a senha!",Toast.LENGTH_SHORT).show();
                }

            }else{
                Toast.makeText(CadastroActivity.this,"Peencha o e-mail!",Toast.LENGTH_SHORT).show();
            }
        }else{
            Toast.makeText(CadastroActivity.this,"Peencha o nome!",Toast.LENGTH_SHORT).show();
        }
